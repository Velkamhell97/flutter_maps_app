...
class MarkerAPainter extends CustomPainter {
  final String duration;
  final String distance;
  final String title;
  final String subtitle;

  const MarkerAPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final center1 = Offset(radius1, size.height - radius1);
  ...
  @override
  bool shouldRepaint(MarkerAPainter oldDelegate) => false;

  @override
  bool shouldRebuildSemantics(MarkerAPainter oldDelegate) => false;
}